...
public class CheckoutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = false;
            String checkQuantity = bookUtil.checkQuantityEnough(listOrder, listDatabase);
            ...
            request.setAttribute("ERROR_CHECKOUT", Checkout_Message);

        } catch (Exception e) {
            log("Error at Checkout Servlet:" + e.toString());
        } finally {
