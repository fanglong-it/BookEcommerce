...
public class ViewHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            OrderDAO orderHistory = new OrderDAO();
            List<OrderDTO> historyList = null;
            if(username.equals("")&& date.equals("")){
                historyList = orderHistory.getOrderHistory();
            }else if(username.equals("") && !date.equals("")){
                historyList = orderHistory.getOrderHistoryByDate(date);
            }else if(!username.equals("") && date.equals("")){
                historyList = orderHistory.getOrderHistoryByUsername(username);
            }else{
                historyList = orderHistory.getOrderHistory();
            }
            
            session.setAttribute("ORDERHISTORY", historyList);
