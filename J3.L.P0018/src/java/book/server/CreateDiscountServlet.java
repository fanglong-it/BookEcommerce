...
import book.driver.DiscountDTO;
...
public class CreateDiscountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DiscountDTO discount = new DiscountDTO(discountCode, Integer.parseInt(discountValue));
            if(dao.insertDiscount(discount)){
                url = VIEWPRODUCT_PAGE;
            }else{
                Discount_Message = "Can't Create this Discount";
            }
            session.setAttribute("ERROR_DISCOUNT", Discount_Message);
        } catch (Exception e) {
            log("Error at CreateDiscountServlet:" + e.toString());
        } finally {
