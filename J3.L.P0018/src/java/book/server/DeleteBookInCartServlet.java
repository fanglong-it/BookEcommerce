 ...
 * @author Admin
 */
@WebServlet(name = "DeleteBookInCartServlet", urlPatterns = {"/DeleteBookInCartServlet"})
public class DeleteBookInCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            util.deleteBookInList(listBook, bookId);
            ...
            log("Error at DeleteBookInCartServlet: " + e.toString());
        } finally {
