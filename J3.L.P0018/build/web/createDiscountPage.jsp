<%-- 
    ...
    Created on : Jul 9, 2021, 10:50:54 AM
    Author     : Admin
--%>
                                    ...
                                    <form action="DispatchServlet">
                                        <aside class="col-sm-12">
                                            <article class="card-body p-5">
                                                <dt>DiscountCode</dt>
                                                <h3 class="title mb-3"><input style="width: 100% ;" type="text" name="discountCode" value="" /></h3>

                                                <p class="price-detail-wrap"> 
                                                <dt>Discount Value</dt>
                                                    <span class="price h3 text-warning"> 
                                                        <span class="currency">%</span><span class="num"><input type="text" name="discountValue" value="" /></span>
                                                    </span> 
                                                </p> <!-- price-detail-wrap .// -->
                                                <!-- row.// -->
                                                </div><!-- row.// -->
                                                ...
                                                <c:if test="${not empty sessionScope.ERROR_DISCOUNT}">
                                                    <p style="color: red">${sessionScope.ERROR_DISCOUNT}</p>
                                                </c:if>
                                                <button class="btn btn-lg btn-outline-success text-uppercase" type="submit" name="btnAction" value="CreateDiscount">Create Discount</button>
                                            </article> <!-- card-body.// -->
                                        </aside>
                                    </form>
                                    <!-- col.// -->
